...
* [GPUWeb](https://github.com/gpuweb/gpuweb) ⭐ 5,482 | 🐛 453 | 🌐 Bikeshed | 📅 2026-09-23 - Official GitHub repository.
...
* [Implementation status](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) ⭐ 5,482 | 🐛 453 | 🌐 Bikeshed | 📅 2026-09-23 - Platform support and rollout details maintained by GPUWeb.
...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 18,120 | 🐛 1,258 | 🌐 Rust | 📅 2026-09-25 - Cross-platform Rust graphics API based on WebGPU, used by Firefox and native applications.
* [sokol](https://github.com/floooh/sokol/) ⭐ 10,317 | 🐛 132 | 🌐 C | 📅 2026-09-23 - Simple STB-style cross-platform libraries for C and C++.
* [Vello](https://github.com/linebender/vello) ⭐ 4,368 | 🐛 192 | 🌐 Rust | 📅 2026-09-25 - Experimental Rust 2D vector renderer using wgpu and GPU compute.
* [ChartGPU](https://github.com/chartgpu/chartgpu) ⭐ 3,238 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-24 - Interactive charting library using WebGPU for rendering.
* [wgpu-native](https://github.com/gfx-rs/wgpu-native) ⭐ 1,392 | 🐛 70 | 🌐 Rust | 📅 2026-09-24 - Native C interface to the Rust wgpu implementation.
...
* [Emdawnwebgpu](https://github.com/google/dawn/blob/main/src/emdawnwebgpu/pkg/README.md) ⭐ 1,145 | 🐛 6 | 🌐 C++ | 📅 2026-09-25 - Dawn-maintained WebGPU bindings for Emscripten applications.
* [webgpu-headers](https://github.com/webgpu-native/webgpu-headers) ⭐ 587 | 🐛 52 | 🌐 C++ | 📅 2026-09-18 - C/C++ headers.
...
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 384 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-25 - JavaScript WebGPU library, by [@redcamel](https://github.com/redcamel).
...
* [RunMat](https://github.com/runmat-org/runmat) ⭐ 257 | 🐛 25 | 🌐 Rust | 📅 2026-09-24 - GPU-accelerated numerical computing runtime for MATLAB-syntax programs, with browser execution through WebAssembly and WebGPU.
...
* [webgpu-inspector](https://github.com/brendan-duncan/webgpu_inspector) ⭐ 369 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-25 - Inspection debugger for WebGPU.
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 115,889 | 🐛 376 | 🌐 JavaScript | 📅 2026-09-25
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 18,120 | 🐛 1,258 | 🌐 Rust | 📅 2026-09-25
...
* [Darkly.art](https://demo.darkly.art) - Open-source photo editor with an advanced WebGPU compositor written in Rust + WebAssembly - [Repository](https://github.com/darkly-art/darkly) ⭐ 331 | 🐛 6 | 🌐 Rust | 📅 2026-09-25
