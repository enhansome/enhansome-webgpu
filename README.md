...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 17,990 | 🐛 1,263 | 🌐 Rust | 📅 2026-09-11 - Cross-platform Rust graphics API based on WebGPU, used by Firefox and native applications.
* [sokol](https://github.com/floooh/sokol/) ⭐ 10,289 | 🐛 130 | 🌐 C | 📅 2026-09-12 - Simple STB-style cross-platform libraries for C and C++.
* [Vello](https://github.com/linebender/vello) ⭐ 4,330 | 🐛 203 | 🌐 Rust | 📅 2026-09-11 - Experimental Rust 2D vector renderer using wgpu and GPU compute.
...
* [wgpu-native](https://github.com/gfx-rs/wgpu-native) ⭐ 1,373 | 🐛 71 | 🌐 Rust | 📅 2026-09-08 - Native C interface to the Rust wgpu implementation.
* [React Native WebGPU](https://github.com/wcandillon/react-native-webgpu) ⭐ 1,235 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-10 - React Native implementation of WebGPU using Dawn.
* [Emdawnwebgpu](https://github.com/google/dawn/blob/main/src/emdawnwebgpu/pkg/README.md) ⭐ 1,130 | 🐛 7 | 🌐 C++ | 📅 2026-09-12 - Dawn-maintained WebGPU bindings for Emscripten applications.
...
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 384 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-12 - JavaScript WebGPU library, by [@redcamel](https://github.com/redcamel).
...
* [WESL](https://github.com/webgpu-tools/wesl-spec) ⭐ 307 | 🐛 103 | 📅 2026-09-12 - Community WGSL extensions for `import`, `@if`, and more.
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 115,446 | 🐛 379 | 🌐 JavaScript | 📅 2026-09-12
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 17,990 | 🐛 1,263 | 🌐 Rust | 📅 2026-09-11
