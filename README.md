...
* [GPUWeb](https://github.com/gpuweb/gpuweb) ⭐ 5,482 | 🐛 454 | 🌐 Bikeshed | 📅 2026-09-23 - Official GitHub repository.
...
* [Implementation status](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) ⭐ 5,482 | 🐛 454 | 🌐 Bikeshed | 📅 2026-09-23 - Platform support and rollout details maintained by GPUWeb.
...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 18,129 | 🐛 1,262 | 🌐 Rust | 📅 2026-09-25 - Cross-platform Rust graphics API based on WebGPU, used by Firefox and native applications.
* [sokol](https://github.com/floooh/sokol/) ⭐ 10,317 | 🐛 132 | 🌐 C | 📅 2026-09-26 - Simple STB-style cross-platform libraries for C and C++.
* [Vello](https://github.com/linebender/vello) ⭐ 4,372 | 🐛 192 | 🌐 Rust | 📅 2026-09-26 - Experimental Rust 2D vector renderer using wgpu and GPU compute.
...
* [Emdawnwebgpu](https://github.com/google/dawn/blob/main/src/emdawnwebgpu/pkg/README.md) ⭐ 1,147 | 🐛 6 | 🌐 C++ | 📅 2026-09-26 - Dawn-maintained WebGPU bindings for Emscripten applications.
...
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 384 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-26 - JavaScript WebGPU library, by [@redcamel](https://github.com/redcamel).
...
* [WESL](https://github.com/webgpu-tools/wesl-spec) ⭐ 312 | 🐛 107 | 📅 2026-09-25 - Community WGSL extensions for `import`, `@if`, and more.
...
* [RunMat](https://github.com/runmat-org/runmat) ⭐ 257 | 🐛 25 | 🌐 Rust | 📅 2026-09-25 - GPU-accelerated numerical computing runtime for MATLAB-syntax programs, with browser execution through WebAssembly and WebGPU.
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 115,937 | 🐛 375 | 🌐 JavaScript | 📅 2026-09-26
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 18,129 | 🐛 1,262 | 🌐 Rust | 📅 2026-09-25
...
* [Darkly.art](https://demo.darkly.art) - Open-source photo editor with an advanced WebGPU compositor written in Rust + WebAssembly - [Repository](https://github.com/darkly-art/darkly) ⭐ 339 | 🐛 3 | 🌐 Rust | 📅 2026-09-26
