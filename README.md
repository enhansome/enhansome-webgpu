...
* [GPUWeb](https://github.com/gpuweb/gpuweb) ⭐ 5,473 | 🐛 454 | 📅 2026-09-01 - Official GitHub repository.
...
* [Implementation status](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) ⭐ 5,473 | 🐛 454 | 📅 2026-09-01 - Platform support and rollout details maintained by GPUWeb.
...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 18,075 | 🐛 1,260 | 🌐 Rust | 📅 2026-09-15 - Cross-platform Rust graphics API based on WebGPU, used by Firefox and native applications.
* [sokol](https://github.com/floooh/sokol/) ⭐ 10,289 | 🐛 129 | 🌐 C | 📅 2026-09-15 - Simple STB-style cross-platform libraries for C and C++.
* [Vello](https://github.com/linebender/vello) ⭐ 4,338 | 🐛 204 | 🌐 Rust | 📅 2026-09-15 - Experimental Rust 2D vector renderer using wgpu and GPU compute.
...
* [wgpu-native](https://github.com/gfx-rs/wgpu-native) ⭐ 1,376 | 🐛 69 | 🌐 Rust | 📅 2026-09-15 - Native C interface to the Rust wgpu implementation.
* [React Native WebGPU](https://github.com/wcandillon/react-native-webgpu) ⭐ 1,236 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-15 - React Native implementation of WebGPU using Dawn.
* [Emdawnwebgpu](https://github.com/google/dawn/blob/main/src/emdawnwebgpu/pkg/README.md) ⭐ 1,132 | 🐛 5 | 🌐 C++ | 📅 2026-09-15 - Dawn-maintained WebGPU bindings for Emscripten applications.
...
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 384 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-15 - JavaScript WebGPU library, by [@redcamel](https://github.com/redcamel).
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 115,557 | 🐛 381 | 🌐 JavaScript | 📅 2026-09-15
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 18,075 | 🐛 1,260 | 🌐 Rust | 📅 2026-09-15
...
* [Darkly.art](https://demo.darkly.art) - Open-source photo editor with an advanced WebGPU compositor written in Rust + WebAssembly - [Repository](https://github.com/darkly-art/darkly) ⭐ 321 | 🐛 4 | 🌐 Rust | 📅 2026-09-14
