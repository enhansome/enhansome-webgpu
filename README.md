...
* [GPUWeb](https://github.com/gpuweb/gpuweb) ⭐ 5,452 | 🐛 458 | 🌐 Bikeshed | 📅 2026-08-17 - Official GitHub repository.
...
* [Implementation status](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) ⭐ 5,452 | 🐛 458 | 🌐 Bikeshed | 📅 2026-08-17 - Official W3C Group.
...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 17,822 | 🐛 1,245 | 🌐 Rust | 📅 2026-08-19 - Mozilla implementation used in Firefox. Like Dawn, can be used as a standalone package.
* [sokol](https://github.com/floooh/sokol/) ⭐ 10,219 | 🐛 138 | 🌐 C | 📅 2026-08-18 - Simple STB-style cross-platform libraries for C and C++.
* [ChartGPU](https://github.com/chartgpu/chartgpu) ⭐ 3,208 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - High-performance charting library built on WebGPU, handles 1M+ data points at 60fps.
* [React Native WebGPU](https://github.com/wcandillon/react-native-webgpu) ⭐ 1,212 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-06 - React Native implementation of WebGPU using Dawn.
* [webgpu-headers](https://github.com/webgpu-native/webgpu-headers) ⭐ 581 | 🐛 51 | 🌐 C++ | 📅 2026-07-29 - C/C++ headers.
* [WebGPU-C++](https://github.com/eliemichel/WebGPU-Cpp) ⭐ 502 | 🐛 13 | 🌐 C++ | 📅 2025-09-03 - A single-file zero-overhead C++ idiomatic wrapper, by @eliemichel.
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 382 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-19 - JavaScript WbeGPU library, by [@redcamel](https://github.com/redcamel).
* [WESL](https://github.com/wgsl-tooling-wg/wesl-spec/blob/main/README.md) ⭐ 296 | 🐛 100 | 📅 2026-07-30 - WGSL extensions for `import`, `@if`, and more.
* [wgsl\_reflect](https://github.com/brendan-duncan/wgsl_reflect) ⭐ 292 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - A WebGPU Shading Language parser and reflection library for JavaScript.
* [WebGPU .NET](https://github.com/WaveEngine/WebGPU.NET) ⭐ 200 | 🐛 0 | 🌐 C# | 📅 2026-08-07 - .NET bindings, built on top of wgpu.
* [WebRTX](https://github.com/codedhead/webrtx) ⭐ 163 | 🐛 3 | 🌐 Rust | 📅 2023-10-08 - WebGPU Ray Tracing Extension.
...
* [RedCube](https://github.com/Reon90/redcube) ⭐ 113 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-30 - glTF viewer based on a WebGPU backend.
...
* [Thimbleberry](https://github.com/mighdoll/thimbleberry) ⭐ 21 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-13 - Reusuable WebGPU shaders and support functions.
...
* [webgpu-inspector](https://github.com/brendan-duncan/webgpu_inspector) ⭐ 357 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-16 - Inspection debugger for WebGpu.
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 114,609 | 🐛 371 | 🌐 JavaScript | 📅 2026-08-19
* [WebLLM](https://mlc.ai/web-llm/) - LLM inference engine, by CMU, University of Washington, OctoML, et al - [Repository](https://github.com/mlc-ai/web-llm) ⭐ 18,575 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-04
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 17,822 | 🐛 1,245 | 🌐 Rust | 📅 2026-08-19
* [Web Stable Diffusion](https://mlc.ai/web-stable-diffusion/#text-to-image-generation-demo) - An implementation of the image generator AI model, by CMU, OctoML, Catalyst et al - [Repository](https://github.com/mlc-ai/web-stable-diffusion) ⭐ 3,720 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2024-03-12
* [WebGPU Samples](https://webgpu.github.io/webgpu-samples/) - A set of samples and demos demonstrating the use of the WebGPU API - [Repository](https://github.com/webgpu/webgpu-samples) ⭐ 2,156 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-05
* [Dawn RT](https://github.com/maierfelix/dawn-ray-tracing) ⭐ 302 | 🐛 3 | 🌐 C++ | 📅 2020-09-15 - A fork of dawn with Ray tracing extensions, by Felix Maier.
...
* [WebGPU-Lab](https://s-macke.github.io/WebGPU-Lab/) - Demos and experiments, focused on compute shaders, by [Sebastian Macke](https://github.com/s-macke) - [Repository](https://github.com/s-macke/WebGPU-Lab) ⭐ 50 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-07
* [WebGPU Path Tracing](https://iamferm.in/webgpu-path-tracing/) - A path tracer powered by WebGPU compute shaders, by [Fermin Lozano](https://github.com/ferminLR) - [Repository](https://github.com/ferminLR/webgpu-path-tracing) ⭐ 42 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-30
