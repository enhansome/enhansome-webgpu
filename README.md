...
* [GPUWeb](https://github.com/gpuweb/gpuweb) ⭐ 5,479 | 🐛 457 | 🌐 Bikeshed | 📅 2026-09-21 - Official GitHub repository.
...
* [Implementation status](https://github.com/gpuweb/gpuweb/wiki/Implementation-Status) ⭐ 5,479 | 🐛 457 | 🌐 Bikeshed | 📅 2026-09-21 - Platform support and rollout details maintained by GPUWeb.
...
* [wgpu](https://github.com/gfx-rs/wgpu) ⭐ 18,091 | 🐛 1,258 | 🌐 Rust | 📅 2026-09-22 - Cross-platform Rust graphics API based on WebGPU, used by Firefox and native applications.
* [sokol](https://github.com/floooh/sokol/) ⭐ 10,305 | 🐛 132 | 🌐 C | 📅 2026-09-21 - Simple STB-style cross-platform libraries for C and C++.
* [Vello](https://github.com/linebender/vello) ⭐ 4,362 | 🐛 197 | 🌐 Rust | 📅 2026-09-22 - Experimental Rust 2D vector renderer using wgpu and GPU compute.
* [ChartGPU](https://github.com/chartgpu/chartgpu) ⭐ 3,234 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-24 - Interactive charting library using WebGPU for rendering.
* [wgpu-native](https://github.com/gfx-rs/wgpu-native) ⭐ 1,388 | 🐛 70 | 🌐 Rust | 📅 2026-09-20 - Native C interface to the Rust wgpu implementation.
* [React Native WebGPU](https://github.com/wcandillon/react-native-webgpu) ⭐ 1,238 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-22 - React Native implementation of WebGPU using Dawn.
* [Emdawnwebgpu](https://github.com/google/dawn/blob/main/src/emdawnwebgpu/pkg/README.md) ⭐ 1,141 | 🐛 6 | 🌐 C++ | 📅 2026-09-22 - Dawn-maintained WebGPU bindings for Emscripten applications.
...
* [RedGPU](https://github.com/redcamel/RedGPU) ⭐ 384 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-22 - JavaScript WebGPU library, by [@redcamel](https://github.com/redcamel).
...
* [webgpu-inspector](https://github.com/brendan-duncan/webgpu_inspector) ⭐ 368 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 - Inspection debugger for WebGPU.
...
* [Three.js WebGPU examples](https://threejs.org/examples/?q=webgpu) - A collection of examples from three.js using the WebGPU renderer - [Repository](https://github.com/mrdoob/three.js/tree/dev/examples#:~:text=webgpu_compute.html) ⭐ 115,763 | 🐛 379 | 🌐 JavaScript | 📅 2026-09-22
* [wgpu examples](https://wgpu.rs/examples/) - Official list of examples from the [wgpu](https://wgpu.rs) library - [Repository](https://github.com/gfx-rs/wgpu/tree/trunk/examples) ⭐ 18,091 | 🐛 1,258 | 🌐 Rust | 📅 2026-09-22
...
* [Darkly.art](https://demo.darkly.art) - Open-source photo editor with an advanced WebGPU compositor written in Rust + WebAssembly - [Repository](https://github.com/darkly-art/darkly) ⭐ 325 | 🐛 8 | 🌐 Rust | 📅 2026-09-22
